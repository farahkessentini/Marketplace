                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="{{route('frontend.product-detail') }}" class="nav-item nav-link active">Product Detail</a>
                            ...
                            <a href="{{route('frontend.my-account') }}" class="nav-item nav-link">My Account</a>
                                ...
                                <div class="col-lg-3">
                                    <div class="product-item">
                                        ...
                                        <div class="product-image">
                                            <a href="{{route('frontend.product-detail') }}">
                                                <img src="{{ asset('frontend/img/product-10.jpg') }}" alt="Product Image">
                                            </a>
